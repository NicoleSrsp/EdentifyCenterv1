    ...
    showDialog(
      ...
      builder: (ctx) => StatefulBuilder(
        builder: (context, setDialogState) {
          ...
          final allowedDays = int.tryParse(frequency.replaceAll('x', '')) ?? 1;
          ...
          final weekDays = selectedWeek == null
              ? <DateTime>[]
              : List<DateTime>.generate(5, (i) => selectedWeek!.add(Duration(days: i)));
                  ...
                  children: [
                    ...
                    if (selectedWeek != null) ...[
                      Align(
                        ...
                        child: Text('Select $allowedDays day(s):',
                      ...
                      Wrap(
                        ...
                        children: weekDays.map((d) {
                          ...
                          final disabled = !isSelected && selectedDays.length >= allowedDays;
                          return ChoiceChip(
                            ...
                            onSelected: disabled
                                ? (_) {
                                    ScaffoldMessenger.of(context).showSnackBar(
                                      SnackBar(content: Text('You can only pick $allowedDays day(s)')),
                                    );
                                  }
                                : (selected) {
                                    setDialogState(() {
  ...
  Widget _buildWeeklyTable() {
    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        final weekDays = List<DateTime>.generate(5, (i) => start.add(Duration(days: i)));
        ...
        if (snapshot.hasData) {
          for (var doc in snapshot.data!.docs) {
            ...
            final pDays = (data['days'] as List<dynamic>? ?? []).map((e) => e.toString()).toList();
        ...
        return Column(
          ...
          children: [
            Text("Week: $weekRange", style: const TextStyle(fontWeight: FontWeight.w600)),
            const SizedBox(height: 8),
                  ...
                  TableRow(
                    children: [
                      Container(
                        ...
                        child: const Text('Shift/Day', style: TextStyle(fontWeight: FontWeight.bold)),
                      ),
                      ...weekDays.map(
                        (d) => Container(
                          padding: const EdgeInsets.all(8),
                  ...
                  Row(
                    children: [
                      GestureDetector(
                        ...
                        child: Row(
                          children: [
                            Text(monthYear, style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                      ...
                      IconButton(icon: const Icon(Icons.person_add), onPressed: _addPatient),
                    ],
                  ),
                  const SizedBox(height: 20),
                  Expanded(child: SingleChildScrollView(child: _buildWeeklyTable())),
                ],
              ),
            ),
          ),
